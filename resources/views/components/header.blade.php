    ...
    <section class="header-top">
        ...
        <div class="d-lg-block d-md-block d-none">
            <div class="search-container">
                ...
                <div class="search-input-box">
                    <form id="search-form"  action="{{ route('search') }}"class="search-box-section" onsubmit="performSearch(event)">
        ...
        <div class="d-lg-block d-md-block d-none">
            <div class="right-part">
                @if (Auth::check())
                    <a href="{{ route('logout') }}" class="primary-btn" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        Logout
                    </a>
    ...
    <div class="header-bottom">
        ...
        <nav class="nav-container">
            ...
            <ul class="nav-view">
                ...
                <li class="nav-item"><a href="{{ route('alltrendingcategory') }}" class="nav-link">Trending Products</a></li>
