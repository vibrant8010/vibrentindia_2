                        ...
                        <div class="search-input-box">
                            <form id="search-form" class="search-box-section" method="GET" action="{{ route('search') }}">
                                <div class="search-box-section">
                                    <input type="text" name="query" value="{{ request('query') }}" id="search-bar"
                                        oninput="fetchSuggestions()" autocomplete="off" placeholder="Search here ...">
                    ...
                    <form action="/inquiry" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-container">
                            <div class="custom-input-group">
                                <label class="custom-label">Product Code</label>
                                <input class="custom-input" placeholder="enter product code" type="text"
                                       name="product_id" id="modalProductId" readonly>
                            </div>
                            <div class="custom-input-group">
                                <label class="custom-label">Product Name</label>
                                <input class="custom-input" type="text" name="product_name" id="modalProductName" readonly>
                            </div>
                            <div class="custom-input-group">
                                <label class="custom-label">Your Name</label>
                                <input class="custom-input" type="text" name="name" placeholder="Your Name" id="modalUserName" required>
                            </div>
                        </div>
                        ...
                        <div class="box-container">
                            <div class="custom-input-group">
                                ...
                                <input class="custom-input" type="text" name="companyname" id="modalCompanyName"
                                       placeholder="Your Company Name">
                            </div>
                            
                            <div class="custom-input-group">
                                <label class="custom-label">Email</label>
                                <input class="custom-input" type="email" name="email" id="modalUserEmail"
                        ...
                        <div class="box-container">
                            <div class="custom-input-group">
                                <label class="custom-label">Phone Number</label>
                                <input class="custom-input" type="tel" name="phone" id="modalUserPhone"
                        ...
                        <div class="custom-input-group" style="width: 100%;">
                            <label class="custom-label custom-textarea-lable">Message</label>
                            <textarea name="message" class="custom-input" rows="3"
                                      placeholder="Enter your message here..."></textarea>
                        </div>
