...
<div class="container">
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" name="mobileno" class="form-control" value="{{ old('mobileno') }}" required>
            @error('mobileno')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div id="company-details" style="display: {{ old('role') === 'business' ? 'block' : 'none' }};">
            ...
            <div class="form-group">
                ...
                @enderror
                <!-- Image Preview -->
                <img id="logo_preview" src="#" alt="Logo Preview" style="max-width: 200px; margin-top: 10px; display: none;">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" name="gst_registration_date" class="form-control" value="{{ old('gst_registration_date') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="legal_status" class="form-control" value="{{ old('legal_status') }}">
                @error('legal_status')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" name="nature_of_business" class="form-control" value="{{ old('nature_of_business') }}">
