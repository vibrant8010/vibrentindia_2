    ...
    <div class="wrapper">
              ...
              <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                  <a href="/admin/dashboard" class="logo">
                    <img
                      src="{{ asset('images/mobile-logo.png')}}"
                      alt="navbar brand"
                      class="navbar-brand"
                      height="20"
                    />
              ...
              <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                  <ul class="nav nav-secondary">
                    ...
                    <li class="nav-item">
                      <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('userindex') ? 'active' : '' }}"> <i class="fas fa-user"></i> Users</a>
                  </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.products.index') }}" class="{{ request()->routeIs('products') ? 'active' : '' }}"><i class="fas fa-list"></i> Products</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.inquiry.index') }}" class="{{ request()->routeIs('orders') ? 'active' : '' }}"><i class="fas fa-info"></i>Inquiry</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.blogs.index') }}" class="{{ request()->routeIs('admin.blogs.index') ? 'active' : '' }}"><i class="fas fa-right-from-bracket"></i> Blogs</a>
                    </li>
        ...
        {{-- <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('admin.users') }}" class="{{ request()->routeIs('userindex') ? 'active' : '' }}"><i class="fa-solid fa-user"></i> Users</a>
...
<script src="{{asset('assets/js/core/jquery-3.7.1.min.js')}}"></script>
    ...
    <!-- Chart Circle -->
    <script src="{{asset('assets/plugin/chart-circle/circles.min.js')}}"></script>
