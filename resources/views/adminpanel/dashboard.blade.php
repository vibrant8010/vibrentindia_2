                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p class="text-muted">Total Cache Size</p>
                            </div>
                            <h3 class="text-info fw-bold">{{ $cacheSize }} MB</h3>
                        </div>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-info w-{{ min(($cacheSize / 100) * 100, 100) }}" role="progressbar"></div>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            <p class="text-muted mb-0">Status</p>
                            <p class="text-muted mb-0">{{ $cacheSize > 0 ? 'Cache Exists' : 'No Cache' }}</p>
                        </div>
                        <form action="{{ route('cache.clear') }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-danger btn-block mt-3">Clear Cache</button>
                        </form>
                    </div>
                </div>
            </div>
