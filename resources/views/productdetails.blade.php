            ...
            <div class="row">
                                    ...
                                    <div class="company-details">
                                        <div class="row">
                                            <div class="col-lg-12 d-flex justify-content-between">
                                                <p class="description-title">GST Registration Date: <span class="description-txt">{{
                                                        $product->company->gst_registration_date }}</span></p>
                                                <p class="description-title">Legal Status: <span class="description-txt">{{
                                                        $product->company->legal_status }}</span></p>

                                            </div>
                                        </div>
                                        <p class="description-title">Nature of Business: <span class="description-txt">{{
                                                $product->company->nature_of_business }}</span></p>
                ...
                <div class="col-lg-3">
                    <div class="company-personal-details sticky-top-new">
                        <div class="product-details mt-3">
                            <img src="{{ asset($product->company->logo_url) }}"
                                style="width: 100px;height:100%;margin-bottom: 10px;" alt="{{ $product->companyname }}">
                        </div>
