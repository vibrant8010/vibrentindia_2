            ...
            <div class="col-xl-10 col-lg-11 col-sm-9 col-md-9 col-xl-9">
                ...
                <div class="form-section mt-2">
                    ...
                    <div id="signupForm" class="row g-3 px-5 form-btn-box">
                        <form id="registrationForm" action="<?php echo e(route('business.register.save')); ?>" method="POST"
                        ...
                        <!-- Step 2 -->
                        <form id="signupForm2" action="<?php echo e(route('user.otp.verify')); ?>" method="POST"
                            class="form-main row mt-3">
                            <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#sendOtp").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('business.register.save')); ?>",
                    headers: {
            ...
            //     $.ajax({
            //         url: "<?php echo e(route('user.otp.verify')); ?>",
            //         headers: {
            ...
            $("#verifyOtp").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('user.otp.verify')); ?>", // Ensure the route is correct
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
...
<?php /**PATH C:\xampp\htdocs\vibrant_trade\resources\views/Auth/register.blade.php ENDPATH**/ ?>