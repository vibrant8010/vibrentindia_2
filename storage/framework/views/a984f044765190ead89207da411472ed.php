                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select class="form-select" id="gender" name="role">
                                                    ...
                                                    <option value="business" <?php echo e($user->role == 'business' ? 'selected' : ''); ?>>Business</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                <label>Phone</label>
                                                <input type="text" class="form-control" value="<?php echo e($user->mobileno); ?>"
...
<?php echo $__env->make('businesspanel.busniesspanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vibrant_trade\resources\views/businesspanel/Users/edit.blade.php ENDPATH**/ ?>